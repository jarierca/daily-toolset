...
const links = [
  ...
  { label: "Task Center", links: [
    { to: "/tasks", label: "Tasks", svg: '' },
    { to: "/tasks/toDoList", label: "To Do List", svg: '' },
    { to: "/tasks/notes", label: "Notes", svg: '' },
    { to: "/tasks/calendar", label: "Calendar", svg: '' },
  ]},
  { label: "Paint", to: "/paint", svg: '' },
];
